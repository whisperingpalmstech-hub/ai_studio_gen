export const WORKFLOW_TEMPLATES = [
    ...
    },
    {
        ...
        nodes: [
            ...
            { id: '2', type: 'loadModel', position: { x: 50, y: 300 }, data: { label: 'Main Model (SD1.5)', model: 'v1-5-pruned-emaonly.safetensors' } },
            ...
            { id: '5', type: 'adLoader', position: { x: 50, y: 550 }, data: { label: 'AnimateDiff Module', model: 'mm_sd_v15_v2.ckpt' } },
            { id: '6', type: 'adApply', position: { x: 400, y: 400 }, data: { label: 'AnimateDiff Context' } },
            { id: '7', type: 'controlNet', position: { x: 750, y: 50 }, data: { label: 'Lineart Control', model: 'control_v11p_sd15_lineart.pth', strength: 0.7 } },
            { id: '8', type: 'controlNet', position: { x: 750, y: 250 }, data: { label: 'Depth Control', model: 'control_v11p_sd15_depth.pth', strength: 0.5 } },
